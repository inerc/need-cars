...
class BreadCrumbs {
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $this->config = array_merge(array(
             ...
             */
            'maxDelimiter' => '...',
            'bcTplCrumbCurrent' => '<li itemscope="itemscope" class="current" itemtype="http://data-vocabulary.org/Breadcrumb">[[+text]]</li>',
            'bcTplCrumbCurrentLink' => '<a class="current" itemprop="url" rel="[[+description]]" href="[[~[[+resource]]]]"><span itemprop="title">[[+text]]</span></a>',
            'bcTplCrumbFirst' => '<li class="first" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb">[[+text]]</li>',
            'bcTplCrumbHome' => '<a class="home" itemprop="url" rel="[[+description]]" href="[[~[[++site_start]]]]"><span itemprop="title">[[+text]]</span></a>',
            'bcTplCrumbLast' => '<li class="last" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb">[[+text]]</li>',
            'bcTplCrumbMax' => '<li class="hide" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb">[[+text]]</li>',
            'bcTplCrumbLink' => '<a class="crumb" itemprop="url" rel="[[+description]]" href="[[~[[+resource]]]]"><span itemprop="title">[[+text]]</span></a>',
            'bcTplCrumbOuter' => '<ul class="box">[[+text]]</ul>',
            'bcTplCrumb' => '<li itemscope="itemscope" class="crumb" itemtype="http://data-vocabulary.org/Breadcrumb">[[+text]]</li>',
        ),$config);
        $this->_crumbs = array();
        $this->_tpls = array();
    }
